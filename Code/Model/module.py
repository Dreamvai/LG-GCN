...
class Wangyufan(nn.Module):
    def __init__(self, c_in, hidden_size, nc):
        ...
        self.gcn_1 = gnn.GCNConv(hidden_size, hidden_size)
    ...
    def forward(self, graph, fullGraph):
        ...
        h2 = F.relu(self.gcn(h1, graph.edge_index))
